<?php
	...
	if(isset($_POST['signup'])){
		...
		// 	$recaptcha = new \ReCaptcha\ReCaptcha('6LfYTr4ZAAAAAD9TZw31qByhhVTq7fEpQ7HNrbhs', new \ReCaptcha\RequestMethod\SocketPost());
			...
			if($row['numrows'] > 0){
				...
				try{
					...
					$message = "
						...
						<a href='http://localhost/ecommerce/activate.php?user=".$userid."'>Activate Account</a>
					";
